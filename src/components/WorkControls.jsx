...
export default class WorkControls extends React.Component {
	...
	leftArrowSvg() {
		return (
			<g className='hvr-backward' id="prev" onClick={() => this.props.onNextOrPrev('slide-left')}>
	...
	rightArrowSvg() {
		return (
			<g className='hvr-forward' id="next" onClick={() => this.props.onNextOrPrev('slide-right')}>
