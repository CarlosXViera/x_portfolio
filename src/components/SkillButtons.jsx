...
const Server = (onClick) => {
	return (
		<g id="server" onClick={() => onClick('back-end')}>
			<rect fill='rgba(0,0,0,0)' x='195' width='80' height='65'></rect>
...
const Laptop = (onClick) => {
	return (
		<g id="laptop" onClick={() => onClick('front-end')}>
...
const Gears = (onClick) => {
	return (
		<g id="gears" onClick={() => onClick('dev-ops')}>
...
const SkillButtons = ({handleClick}) => {
